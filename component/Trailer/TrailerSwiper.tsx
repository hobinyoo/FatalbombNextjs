...
import { trailer } from "../../store/features/clickedSwiperSlice"
...
const TrailerSwiper = ({ mobileResize }: mobileResizeProps) => {
        ...
        if (!swiperSetting) {
            setSwiperSetting({
                ...
                onClick: (swiper: SwiperCore): void => {
                    const trailerNum = swiper.clickedSlide.id 
                    dispatch(trailer(trailerNum))
                },
